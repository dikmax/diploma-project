...
//jQuery.prototype.get = function() {} - the jQuery itself is an array
//jQuery.prototype.get = function(index) {} - $()[index]
 ...
 * @param callback	A callback(index, domElement), that can return an element's replacement.
 * @return jQuery
 * @type jQuery
 */
 ...
 * @param elem Node A DOM elemen that will be wrapped around the target.
 * @return jQuery
 * @type jQuery
 */
...
/** (Effects/Custom) 
 * <u>1:</u> queue() Returns a reference to the first element's queue (which is an array of functions).
 * <u>2:</u> queue(callback) Adds a new function, to be executed, onto the end of the queue of all matched elements.
 * <u>3:</u> queue(queue) Replaces the queue of all matched element with this new queue (the array of functions).
 ...
 * <u>WARNING:</u> Safari 2 and older is unable to evaluate scripts in a global context synchronously. If you load functions via getScript, make sure to call them after a delay.
 * @param url String The URL of the page to load.
 * @param callback Function(data, textStatus) Will be executed when the data is loaded successfully. `this` is the options for the request.
 * @return XMLHttpRequest
 * @type XMLHttpRequest
